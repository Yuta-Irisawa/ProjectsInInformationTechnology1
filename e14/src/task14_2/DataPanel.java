...
class DataPanel implements ActionListener {
    ...
    DataPanel(JFrame newFrame) {
        ...
        paramLabels[scale] = new JLabel("Scale");
        ...
        paramFields[xLowerIndex] = new JTextField("-8");
        paramFields[xUpperIndex] = new JTextField("8");
        paramFields[xIntervalIndex] = new JTextField("1");
        paramFields[yLowerIndex] = new JTextField("-8");
        paramFields[yUpperIndex] = new JTextField("8");
        paramFields[yIntervalIndex] = new JTextField("1");
        paramFields[scale] = new JTextField("1");
    ...
    void refreshData() {
        ...
        polynominals = Integer.parseInt(paramFields[scale].getText());
